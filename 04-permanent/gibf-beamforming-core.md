...
[[suzuki-2011-gibf]] — primary literature source for the algorithm itself (Eqs. 1-4)
...
Suzuki 2011 (*J. Sound Vib.* 330: 5835-5851) — read directly, see [[suzuki-2011-gibf]] for the algorithm's aeroacoustic origin, PDF at `Desktop\School\IBF_Project\Suzuki GIBF.pdf`. Wax & Kailath 1985 (IEEE TASSP, AIC/MDL mode selection) — cited secondhand only, no local PDF, not yet read. Empirical φ/κ figures derived directly in the mag-GIBF project's roadmap desk-checks (`Python\mag-GIBF\ROADMAP (1).md`, Experiment Log entries 2026-06-30/07-01), not yet published anywhere external.
